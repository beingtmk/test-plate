...
const forcedLayout: any = (
  <fragment>
    ...
    <hp>
      ...
      ratione quod incidunt molestias laudantium id, delectus quaerat, fugit
      beatae molestiae, ipsam optio illum ullam officia iste! Possimus, aliquam
      sequi!
    </hp>
  </fragment>
)
  ...
  <fragment>
    <hp>
      <htext color="white" backgroundColor="black" fontSize="30px">
        This text has white color, black background
      </htext>
    </hp>
    <hp>
